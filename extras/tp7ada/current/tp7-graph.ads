...
package TP7.Graph is
   ...
   CGAC0 : constant := 0;     -- 320x200 palette 0: LightGreen, LightRed,
                              --Yellow; 1 page
   CGAC1 : constant := 1;     -- 320x200 palette 1: LightCyan,
                              --LightMagenta, White; 1 page
   CGAC2 : constant := 2;     -- 320x200 palette 2: Green, Red, Brown; 1
                              --page
   CGAC3 : constant := 3;     -- 320x200 palette 3: Cyan, Magenta,
                              --LightGray; 1 page
   CGAHi : constant := 4;  -- 640x200 1 page
   MCGAC0 : constant := 0;    -- 320x200 palette 0: LightGreen, LightRed,
                              --Yellow; 1 page
   MCGAC1 : constant := 1;    -- 320x200 palette 1: LightCyan,
                              --LightMagenta, White; 1 page
   MCGAC2 : constant := 2;    -- 320x200 palette 2: Green, Red, Brown; 1
                              --page
   MCGAC3 : constant := 3;    -- 320x200 palette 3: Cyan, Magenta,
                              --LightGray; 1 page
   ...
   EGAMonoHi : constant := 3;    -- 640x350 64K on card, 1 page; 256K on card,
                                 --2 page
   HercMonoHi : constant := 0;  -- 720x348 2 page
   ATT400C0 : constant := 0;     -- 320x200 palette 0: LightGreen, LightRed,
                                 --Yellow; 1 page
   ATT400C1 : constant := 1;     -- 320x200 palette 1: LightCyan,
                                 --LightMagenta, White; 1 page
   ATT400C2 : constant := 2;     -- 320x200 palette 2: Green, Red, Brown; 1
                                 --page
   ATT400C3 : constant := 3;     -- 320x200 palette 3: Cyan, Magenta,
                                 --LightGray; 1 page
